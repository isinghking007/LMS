    ...
    public class DataAccess : IDataAccess
    {
        ...
        public int CreateUser(User user)
        {
            ...
            using(var conn = new SqlConnection(DbConnection))
            {
                ...
                var sql = "insert into Users(FirstName,LastName,Email,Mobile,Password,Blocked,Active,CreatedOn,UserType) values(@fn,@ln,@em,@ph,@pwd,@blk,@act,@con,@type);";
        ...
        {
            var orderedBook = false;

            using (var connection = new SqlConnection(DbConnection))
            {
                var date= DateTime.Now.Year + "." + DateTime.Now.Month + "." + DateTime.Now.Day +
               " " + DateTime.Now.Hour + (":") + DateTime.Now.Minute + (":") + DateTime.Now.Second;
                var sql = $"insert into Orders(UserId,BookId,OrderedOn,Returned) values({userid},{bookid},'{date}',0);";
        ...
        public IList<Order> GetOrderOfUser(int userid)
        {
